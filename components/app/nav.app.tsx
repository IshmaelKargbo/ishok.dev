...
export const Nav = () => {
    ...
    return (
        <div>
            <nav className="md:px-14 px-6 container mx-auto flex items-center justify-between md:py-2 z-10">
                <div className="flex">
                ...
                <div className="hidden md:block">
                    <ul className="flex space-x-5 items-center">
                        <li>
                            <Navlink title="Home" count="01" href="/app" />
                        </li>
                        <li>
                            <Navlink title="Experience" count="02" href="/app/jobs" />
                        </li>
                        <li>
                            <Navlink title="Work" count="03" href="/app/projects" />
                        </li>
                    </ul>
                </div>
